...
<body class="gray">
    <div class="container-fluid px-0">
        <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-white pt-1 align-items-start">
            ...
            <button class="navbar-toggler align-self-center" type="button"  data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false">
                <i class="fa fa-shopping-cart fa-2x" style="color:#0072CE"></i>
            </button>
            <div id="collapse-pc" class="collapse navbar-collapse" id="navbarSupportedContent">
...
<!--
            ...
            <div id="collapse-cel" class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto align-items-start">
                    <li class="nav-item px-3 genders">
                        <div class="d-flex flex-column">
                            <div class="h6 my-0 py-0 text-center font-weight-bold" style="color:#0072CE">Recién nacido</div>
